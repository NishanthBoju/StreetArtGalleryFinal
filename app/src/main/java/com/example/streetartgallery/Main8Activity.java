...
public class Main8Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        out1 =(TextView) findViewById(R.id.textView85);
        out2 =(TextView) findViewById(R.id.textView86);
        out3 =(TextView) findViewById(R.id.textView87);
    ...
    private class MyTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params){
            ...
            try {
                ...
                url = new URL("http://192.168.2.20:8080/FinalProjectTeam7/cegepgim/user/Adduser&"+InfoReceivedId+"&"+nameRecieved1+"&"+nameRecieved2+"&"+nameRecieved3);
